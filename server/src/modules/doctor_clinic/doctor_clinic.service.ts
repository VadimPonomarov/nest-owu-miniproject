...
export class DoctorClinicService {
    ...
    async create(createDoctorClinicDto: CreateDoctorClinicDto): Promise<DoctorClinic> {
        try {
    ...
    async updateOne(doctorClinic: DoctorClinic, updateDoctorClinic: UpdateDoctorClinicDto): Promise<DoctorClinic> {
        try {
    ...
    async removeOne(doctorClinic: DoctorClinic): Promise<DoctorClinic> {
        try {
